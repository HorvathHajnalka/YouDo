...
public class GoogleServicesHelper {
    ...
    public void createGoogleCalendarEvent(GoogleSignInAccount account, String title, String description, java.util.Calendar startTime, java.util.Calendar endTime, GoogleCalendarEventCallback callback) {
        try {
            ...
            event.setStart(new EventDateTime().setDateTime(new com.google.api.client.util.DateTime(startDateTime)).setTimeZone("UTC"));
            event.setEnd(new EventDateTime().setDateTime(new com.google.api.client.util.DateTime(endDateTime)).setTimeZone("UTC"));
